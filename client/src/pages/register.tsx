    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 flex items-center justify-center p-2">
      <div className="w-full max-w-md bg-white rounded-xl shadow-2xl p-4 border border-gray-200 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-3" noValidate>
          ...
          {/* Workshop-specific fields (only show for Marine workshop rank) */}
          {formData.maritimeRank === "Marine workshop" && (
            <>
              {/* Competency/Expertise System */}
              <div>
                <Label htmlFor="competencyExpertise" className="text-xs font-medium text-gray-700 mb-1 block">
                  Competency/Expertise System *
                </Label>
                <Input
                  id="competencyExpertise"
                  type="text"
                  value={formData.competencyExpertise}
                  onChange={(e) => setFormData({ ...formData, competencyExpertise: e.target.value })}
                  placeholder="e.g., Main Engine Repairs, Electrical Systems, Navigation Equipment"
                  className="w-full h-8 text-sm"
                  disabled={loading || otpLoading || otpSent}
                  required
                />
              ...
              {/* Home Port */}
              <div>
                <Label htmlFor="homePort" className="text-xs font-medium text-gray-700 mb-1 block">
                  Home Port *
                </Label>
                <Input
                  id="homePort"
                  ...
                  placeholder="e.g., Singapore, Dubai, Mumbai"
                  className="w-full h-8 text-sm"
                  disabled={loading || otpLoading || otpSent}
                  required
                />
              ...
              {/* Service Engineer Visa Status */}
              <div>
                <Label htmlFor="visaStatus" className="text-xs font-medium text-gray-700 mb-1 block">
                  Service Engineer Visa Status *
                </Label>
                <Select 
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Local National">Local National</SelectItem>
                    <SelectItem value="Multiple Entry Visa">Multiple Entry Visa</SelectItem>
                    <SelectItem value="Transit Visa Only">Transit Visa Only</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div>
                <Label htmlFor="companiesWorkedFor" className="text-xs font-medium text-gray-700 mb-1 block">
                  Companies Worked For (in last 1 year) *
                </Label>
                <Input
                  id="companiesWorkedFor"
                  type="text"
                  value={formData.companiesWorkedFor}
                  onChange={(e) => setFormData({ ...formData, companiesWorkedFor: e.target.value })}
                  placeholder="e.g., Maersk, MSC, Anglo Eastern"
                  className="w-full h-8 text-sm"
                  disabled={loading || otpLoading || otpSent}
                  required
                />
              ...
              <div>
                <Label htmlFor="officialWebsite" className="text-xs font-medium text-gray-700 mb-1 block">
                  Official Workshop Website
                </Label>
                <Input
                  id="officialWebsite"
              ...
              <div>
                <Label htmlFor="perDayAttendanceRate" className="text-xs font-medium text-gray-700 mb-1 block">
                  Per Day Attendance of Service Engineer (In USD) *
                </Label>
                <Input
                  id="perDayAttendanceRate"
                  type="number"
                  value={formData.perDayAttendanceRate}
                  onChange={(e) => setFormData({ ...formData, perDayAttendanceRate: e.target.value })}
                  placeholder="e.g., 500"
                  className="w-full h-8 text-sm"
                  disabled={loading || otpLoading || otpSent}
                  required
              ...
              {/* Remote Troubleshooting Rate */}
              <div>
                <Label htmlFor="remoteTroubleshootingRate" className="text-xs font-medium text-gray-700 mb-1 block">
                  Remote Troubleshooting Service Tariff/Hour (In USD) *
                </Label>
                <Input
                  id="remoteTroubleshootingRate"
                  type="number"
                  value={formData.remoteTroubleshootingRate}
                  onChange={(e) => setFormData({ ...formData, remoteTroubleshootingRate: e.target.value })}
                  placeholder="e.g., 150"
                  className="w-full h-8 text-sm"
                  disabled={loading || otpLoading || otpSent}
                  required
