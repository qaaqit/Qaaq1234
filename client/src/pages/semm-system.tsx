...
const FlipCard = ({ char, index, large = false }: { char: string; index: number; large?: boolean }) => {
  ...
  const cardSize = large ? 'w-12 h-16' : 'w-6 h-9';
  const textSize = large ? 'text-xl' : 'text-xs';
  ...
  return (
    <div className={`relative ${cardSize} bg-black rounded-md overflow-hidden border border-gray-600 shadow-xl`}>
      ...
      <div className="relative h-1/2 overflow-hidden" style={{ perspective: '600px' }}>
        ...
        >
          <div className="w-1.5 h-1.5 border border-white border-t-transparent rounded-full animate-spin mb-0.5"></div>
        </div>
      ...
      <div className="relative h-1/2 overflow-hidden" style={{ perspective: '600px' }}>
        ...
        >
          <div className="w-1.5 h-1.5 border border-white border-t-transparent rounded-full animate-spin mt-0.5"></div>
        </div>
